...
export function renderNoticesList(filter = "all") {
  ...
  if (filter !== "all") {
    filteredNotices = noticesArray.filter(
      (notice) => notice.category === filter
    );
  }
  ...
  const noticesHTML = filteredNotices
    .map((notice) => {
          ...
          <div class="attachment-list">
            ${notice.attachments
              ...
              <div class="attachment-item">
                <span class="attachment-icon">${getFileIcon(
                  attachment.name
                )}</span>
                <span class="attachment-name">${attachment.name}</span>
                <a href="${
                  attachment.url
                }" target="_blank" class="attachment-download">Download</a>
              </div>
            `
              )
              .join("")}
